...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isLoggedIn) {
            Intent intent = new Intent(UserProfileActivity.this, UserAuthenticationActivity.class);
        ...
        settingsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UserProfileActivity.this, AppSettingsActivity.class));
            }
        });
        ...
        try {
            ...
            if (!userEmail.isEmpty()) {
                ...
                if (user != null) {
                    ...
                    // Make reports count clickable to view report history
                    reportsCountTextView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            startActivity(new Intent(UserProfileActivity.this, ReportAnalyticsActivity.class));
                        }
                    });
                } else {
